  ...
  final Map<String, DataFetchable> Function(BuildContext) _providerMap =
      (ctx) => {
        //'companies': Provider.of<CompanyProvider>(ctx, listen: false),
				'products': Provider.of<ProductsProvider>(ctx, listen: false),
				'orders': Provider.of<OrdersProvider>(ctx, listen: false),
				'customers': Provider.of<CustomersProvider>(ctx, listen: false),
				'items': Provider.of<ItemsProvider>(ctx, listen: false),
